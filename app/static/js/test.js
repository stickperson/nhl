d3 = function() {
    ...
    function me(n) {
        ...
        function u(t, e, r, a, c, s, l, f, h, g, p, v, d, m) {
            ...
            if (M > 4 * i && d--) {
                var _ = a + g, b = c + p, w = s + v, S = Math.sqrt(_ * _ + b * b + w * w), k = Math.asin(w /= S), E = aa(aa(w) - 1) < Ca || aa(r - h) < Ca ? (r + h) / 2 : Math.atan2(b, _), A = n(E, k), C = A[0], N = A[1], L = C - t, T = N - e, q = x * L - y * T;
    ...
    function tu(n, t) {
        ...
        u.push({
            ...
            i: 3,
            x: Lr(a[1], c[1])
        })) : c[0] || c[1] ? r.push("translate(" + c + ")") : r.push(""), s != l ? (s - l > 180 ? l += 360 : l - s > 180 && (s += 360), 
        u.push({
